...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <WhatsAppCTA title="Fastest way to reach Hezpo" text="Choose WhatsApp for product questions, wholesale pricing, dealer applications or salon support." message="Hi Hezpo, I want to make an inquiry." />
